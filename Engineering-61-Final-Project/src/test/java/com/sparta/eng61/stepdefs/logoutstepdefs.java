...
public class logoutstepdefs {
    ...
    public void iAmOnTheSendAssessmentPage(){
        //  Assertions.assertTrue("https://eng61.spartaglobal.academy/",loginPage.openLoginPage().login().openSendAssessmentPage().getURL());
    }
    @Given("I am on the Dispatches page")
    public void iAmOnTheDispatchesPage() {
        //  Assertions.assertTrue("https://eng61.spartaglobal.academy/",loginPage.openLoginPage().login().openDispatchesPage().getURL());
    }

    @Given("I am on the Results page")
    public void iAmOnTheResultsPage() {
        //  Assertions.assertTrue("https://eng61.spartaglobal.academy/",loginPage.openLoginPage().login().openResultsPage().getURL());
    }

    @Given("I am on the Polls page")
    public void iAmOnThePollsPage() {
        //  Assertions.assertTrue("https://eng61.spartaglobal.academy/",loginPage.openLoginPage().login().openPollsPage().getURL());
    }
